    ...
    <div class="menu_inner">
        ...
        <div class="menu_container">
            ...
            <div class="menu_inner">
                ...
                <div class="menu">
                    <ul class="menu_list">
                        <li class="menu_item"><a href="{!! route('main') !!}">Inicio</a></li>
                        <li class="menu_item"><a href="{!! route('carta.index') !!}">Carta</a></li>
                        <li class="menu_item"><a href="{!! route('menu.index') !!}">Menú del Día</a></li>
                        @if (Auth::user() != null)
                            <li class="menu_item"><a href="{!! route('reserva', ['email' => Auth::user()->email]) !!}">Reservas</a></li>
                        @else
                        ...
                        @Auth
                            ...
                            @else
                            <li class="menu_item"><a href="{{ route('login') }}">Iniciar Sesión</a></li>

                            @if (Route::has('register'))
                                <li class="menu_item"><a href="{{ route('register') }}">Registro</a></li>
                            @endif
                            </li>
                        @endauth
                    </ul>
