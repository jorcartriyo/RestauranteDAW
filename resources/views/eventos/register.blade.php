                                    ...
                                    <div class="picture-container">
                                        <div>
                                            <img src="{{ asset('assets/img/product.png') }}" onchange="mostrarImagen(event)"
                                                name="imgEvento" id="imgUsu" title="Imagen Evento" />
                                            <br>
                    ...
                    <div class="col-lg-18">
                        <div class="input-group form-control-lg">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0" value=' ' style="resize: both;" id="descripcion" name="descripcionCorta"
                                    rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-18">
                        <div class="input-group form-control-lg">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="dia" name="dia" autocomplete="on"
                                    value=0 min="0" max="31">
                            </div>
                        </div>
                    </div>
                    {{-- Mes --}}
                        ...
                        <div class="input-group form-control-lg">
                            ...
                            <div class="form-group">
                                <label for="precio" class="bmd-label-floating"> Mes
                                    (required)</label>
                                <input type="text" class="form-control" id="mes" required="true" name="mes"
                                    autocomplete="on">
                            </div>
                        </div>
                    </div>
