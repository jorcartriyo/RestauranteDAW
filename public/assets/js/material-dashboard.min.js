...
isWindows
    ? (0 != $(".main-panel").length &&
      ...
      0 != $(".sidebar").length &&
          ...
          (ps1 = new PerfectScrollbar(sidebar))),
      0 != $(".sidebar-wrapper").length &&
          ((sidebarwrapper = document.querySelector(".sidebar-wrapper")),
          (ps2 = new PerfectScrollbar(sidebarwrapper))),
      0 != $(".dropdown-menu").length &&
          ((dropdownmenu = document.querySelector(".dropdown-menu")),
          (ps3 = new PerfectScrollbar(dropdownmenu))),
      0 != $(".page-header").length &&
          ((pageheader = document.querySelector(".page-header")),
          (ps4 = new PerfectScrollbar(pageheader))),
        ...
        $(".dropdown-menu a.dropdown-toggle").on("click", function (e) {
            ...
            return (
                ...
                a.parent().hasClass("navbar-nav") ||
                    t
                        .next()
                        .css({ top: t[0].offsetTop, left: a.outerWidth() - 4 }),
                !1
            );
        }),
    ...
    (md = {
        ...
        initDashboardPageCharts: function () {
            ...
            (0 == $("#dailySalesChart").length &&
                ...
                md.startAnimationForLineChart(t),
                (a = Chartist.Bar(
                    "#websiteViewsChart",
                    {
                        labels: [
            ...
            ($calendar = $("#fullCalendar")),
                ...
                $calendar.fullCalendar({
                    viewRender: function (e, t) {
                        "month" != e.name &&
                            $(t).find(".fc-scroller").perfectScrollbar();
                    },
                    header: {
                        left: "title",
    ...
    (demo = {
            ...
            $(function () {
                ...
                function e() {
                    $(".add-animation:not(.animated)").each(function () {
                        var e = $(this);
                        e.offset().top < a.scrollTop() + a.height() &&
                            e.addClass("animated");
                    }),
                        $(".add-animation.animated").each(function (e) {
                            ...
                            (scrolled = a.scrollTop()),
                                ...
                                (win_height_padded = 0.8 * windowHeight),
        ...
        initPickColor: function () {
            $(".pick-class-label").click(function () {
                var e,
                    t = $(this).attr("new-class"),
                    a = $("#display-buttons").attr("data-class"),
                    i = $("#display-buttons");
                i.length &&
                    ((e = i.find(".btn")).removeClass(a),
                    e.addClass(t),
                    i.attr("data-class", t));
            });
        },
        initMaterialWizard: function () {
            ...
            function r(e, t) {
                ($total = e.find(".nav li").length),
                    ($li_width = 100 / $total),
                    (total_steps = e.find(".nav li").length),
                    (move_distance = e.width() / total_steps),
                    (index_temp = t),
                    (vertical_level = 0),
                    (mobile_device = $(document).width() < 600 && 3 < $total),
                    mobile_device &&
                        ((move_distance = e.width() / 2),
                        (index_temp = t % 2),
                        ($li_width = 50)),
                    e.find(".nav li").css("width", $li_width + "%"),
                    (step_width = move_distance),
                    (move_distance *= index_temp),
                    ($current = t + 1),
                    1 == $current || (1 == mobile_device && t % 2 == 0)
                        ? (move_distance -= 8)
                        : ($current == total_steps ||
                              (1 == mobile_device && t % 2 == 1)) &&
                          (move_distance += 8),
                    mobile_device &&
                        ((vertical_level = parseInt(t / 2)),
                        (vertical_level *= 38)),
                    e.find(".moving-tab").css("width", step_width),
                    $(".moving-tab").css({
                        transform:
                            "translate3d(" +
                            move_distance +
                            ...
                            "px, 0)",
                        transition:
                            "all 0.5s cubic-bezier(0.29, 1.42, 0.79, 1)",
                    });
            }
            $(".card-wizard").bootstrapWizard({
                ...
                onNext: function (e, t, a) {
                    if (!$(".card-wizard form").valid())
                        return i.focusInvalid(), !1;
                },
                onInit: function (e, t, a) {
                    t.find("li").length;
                    var i = t.closest(".card-wizard");
                    ($first_li = t.find("li:first-child a").html()),
                        ($moving_div = $(
                ...
                onTabShow: function (e, t, a) {
                    var i = t.find("li").length,
                        n = a + 1,
                        o = t.closest(".card-wizard");
                    i <= n
                        ? ($(o).find(".btn-next").hide(),
                          $(o).find(".btn-finish").show())
                        : ($(o).find(".btn-next").show(),
                          $(o).find(".btn-finish").hide()),
                        (button_text = t
                            .find("li:nth-child(" + n + ") a")
                            .html()),
                        setTimeout(function () {
        ...
        initCharts: function () {
            var e, t, a, i, n, o;
            0 != $("#roundedLineChart").length &&
                0 != $("#straightLinesChart").length &&
                0 != $("#colouredRoundedLineChart").length &&
                0 != $("#colouredBarsChart").length &&
                0 != $("#simpleBarChart").length &&
                0 != $("#multipleBarsChart").length &&
                ...
                md.startAnimationForLineChart(i),
                Chartist.Pie(
                    "#chartPreferences",
                ...
                (n = Chartist.Bar(
                    ...
                    { seriesBarDistance: 10, axisX: { showGrid: !1 } },
                    [
                        [
                            "screen and (max-width: 640px)",
                            {
        ...
        showSwal: function (e) {
            "basic" == e
                ...
                : "warning-message-and-confirmation" == e
                ? swal({
                      title: "Are you sure?",
        ...
        initSmallGoogleMaps: function () {
            var e = new google.maps.LatLng(40.748817, -73.985428),
                t = { zoom: 8, center: e, scrollwheel: !1 },
                a = new google.maps.Map(
