                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="info">
                                                    ...
                                                    <p>Tus reservas serán confirmadas mediante una llamada telefónica o tu email.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="info">
                                                    ...
                                                    <p>Los datos de tus reservas, solo son visibles para ti dentro de tu cuenta, nadie mas tiene acceso a la información</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
